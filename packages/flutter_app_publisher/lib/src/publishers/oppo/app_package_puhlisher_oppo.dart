...
class AppPackagePublisherOppo extends AppPackagePublisher {
  ...
  Future<Map<String, dynamic>> uploadFile(String accessToken, String timestamp, Map<String, dynamic> uploadInfo,
      String accessSecret, File file, PublishProgressCallback? onPublishProgress) async {
  ...
  Future<Map<String, dynamic>> updateApp(
    ...
    Map<String, dynamic> query = {
      ...
      'apk_url': {'url': data['url'], 'md5': await generateMd5(file), 'cpu_code': 0},
      // 'app_name':'视客眼镜网',
